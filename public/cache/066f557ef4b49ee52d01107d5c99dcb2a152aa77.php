    ...
    <div class="container">
      ...
      <div class="row" data-aos="fade-in">
        ...
        <div class="col-lg-7 mt-5 mt-lg-0 d-flex align-items-stretch bg-white border rounded shadow" style="padding: 30px">
          <form action="<?php echo e(base_url("contact")); ?>" method="POST" role="form" class="row">
            <div class="row">
              <div class="col-md-12">
...
<?php /**PATH C:\AppServ\www\portfolio\public\views/frontend/layouts/contact.blade.php ENDPATH**/ ?>